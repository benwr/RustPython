...
class Complex(Number):
	...
	def __bool__(A):'True if self != 0. Called for bool(self).';return A!=0
	@property
	@abstractmethod
	def real(self):'Retrieve the real component of this number.\n\n        This should subclass Real.\n        ';raise NotImplementedError
	@property
	@abstractmethod
	def imag(self):'Retrieve the imaginary component of this number.\n\n        This should subclass Real.\n        ';raise NotImplementedError
	@abstractmethod
	...
	def __sub__(A,other):'self - other';return A+-other
	def __rsub__(A,other):'other - self';return-A+other
	@abstractmethod
...
class Real(Complex):
	...
	@abstractmethod
	def __trunc__(self):'trunc(self): Truncates self to an Integral.\n\n        Returns an Integral i such that:\n          * i>0 iff self>0;\n          * abs(i) <= abs(self);\n          * for any Integral j satisfying the first two conditions,\n            abs(i) >= abs(j) [i.e. i has "maximal" abs among those].\n        i.e. "truncate towards 0".\n        ';raise NotImplementedError
	@abstractmethod
	...
	@abstractmethod
	def __round__(self,ndigits=None):'Rounds self to ndigits decimal places, defaulting to 0.\n\n        If ndigits is omitted or None, returns an Integral, otherwise\n        returns a Real. Rounds half toward even.\n        ';raise NotImplementedError
	def __divmod__(A,other):'divmod(self, other): The pair (self // other, self % other).\n\n        Sometimes this can be computed faster than the pair of\n        operations.\n        ';B=other;return A//B,A%B
	def __rdivmod__(A,other):'divmod(other, self): The pair (self // other, self % other).\n\n        Sometimes this can be computed faster than the pair of\n        operations.\n        ';B=other;return B//A,B%A
	@abstractmethod
	def __floordiv__(self,other):'self // other: The floor() of self/other.';raise NotImplementedError
	@abstractmethod
	def __rfloordiv__(self,other):'other // self: The floor() of other/self.';raise NotImplementedError
	@abstractmethod
	def __mod__(self,other):'self % other';raise NotImplementedError
	@abstractmethod
	def __rmod__(self,other):'other % self';raise NotImplementedError
	@abstractmethod
	def __lt__(self,other):'self < other\n\n        < on Reals defines a total ordering, except perhaps for NaN.';raise NotImplementedError
	@abstractmethod
	def __le__(self,other):'self <= other';raise NotImplementedError
	def __complex__(A):'complex(self) == complex(float(self), 0)';return complex(float(A))
	@property
	def real(self):'Real numbers are their real component.';return+self
	@property
	def imag(self):'Real numbers have no imaginary component.';return 0
	def conjugate(A):'Conjugate is a no-op for Reals.';return+A
Real.register(float)
class Rational(Real):
	'.numerator and .denominator should be in lowest terms.';__slots__=()
	@property
	@abstractmethod
	...
	def __float__(A):'float(self) = self.numerator / self.denominator\n\n        It\'s important that this conversion use the integer\'s "true"\n        division rather than casting one side to float before dividing\n        so that ratios of huge integers convert without overflowing.\n\n        ';return A.numerator/A.denominator
class Integral(Rational):
	'Integral adds a conversion to int and the bit-string operations.';__slots__=()
	@abstractmethod
	def __int__(self):'int(self)';raise NotImplementedError
	def __index__(A):'Called whenever an index is needed, such as in slicing';return int(A)
	@abstractmethod
	def __pow__(self,exponent,modulus=None):"self ** exponent % modulus, but maybe faster.\n\n        Accept the modulus argument if you want to support the\n        3-argument version of pow(). Raise a TypeError if exponent < 0\n        or any argument isn't Integral. Otherwise, just implement the\n        2-argument version described in Complex.\n        ";raise NotImplementedError
	@abstractmethod
	...
	@abstractmethod
	def __or__(self,other):'self | other';raise NotImplementedError
	@abstractmethod
	def __ror__(self,other):'other | self';raise NotImplementedError
	@abstractmethod
	def __invert__(self):'~self';raise NotImplementedError
	def __float__(A):'float(self) == float(int(self))';return float(int(A))
	@property
